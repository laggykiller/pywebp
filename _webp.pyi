...
class lib:
    ...
    class WebPBitstreamFeatures:
        ...
        has_animation: int
        format: int
    class WebPBitstreamFeaturesPointer(WebPBitstreamFeatures): ...
    ...
    class WebPConfig:
        ...
        quality: float
        method: int
    class WebPConfigPointer(WebPConfig): ...
    ...
    class WebPAnimEncoder:
        error_code: str
    class WebPAnimEncoderPointer(WebPAnimEncoder): ...
    class WebPAnimDecoder:
        error_code: str
    class WebPAnimDecoderPointer(WebPAnimDecoder): ...
    ...
    @staticmethod
    def WebPGetFeatures(data: Pointer[int], data_size: int, features: WebPBitstreamFeaturesPointer) -> int: ...

    @staticmethod
    def WebPDecode(data: Pointer[int], data_size: int, config: WebPDecoderConfigPointer) -> int: ...

    @staticmethod
    def WebPFreeDecBuffer(buffer: WebPDecBufferPointer) -> None: ...

    @staticmethod
    def WebPConfigPreset(config: WebPConfigPointer, preset: int, quality: float) -> int: ...

    @staticmethod
    def WebPConfigLosslessPreset(config: WebPConfigPointer, level: int) -> int: ...

    @staticmethod
    def WebPValidateConfig(ptr: WebPConfigPointer) -> int: ...

    @staticmethod
    def WebPEncode(config: WebPConfigPointer, picture: WebPPicturePointer) -> int: ...
    ...
    @staticmethod
    def WebPAnimEncoderNew(width: int, height: int, enc_options: WebPAnimEncoderOptionsPointer) -> WebPAnimEncoderPointer: ...

    @staticmethod
    def WebPAnimEncoderAdd(enc: WebPAnimEncoderPointer, frame: Union[Pointer[None], WebPPicturePointer], timestamp_ms: int, config: Union[Pointer[None], WebPConfigPointer]) -> int: ...
    ...
    @staticmethod
    def WebPAnimDecoderNew(webp_data: WebPData, dec_options: WebPAnimDecoderOptionsPointer) -> WebPAnimDecoderPointer: ...

    @staticmethod
    def WebPAnimDecoderGetInfo(dec: Union[Pointer[None], WebPAnimDecoderPointer], info: WebPAnimInfo) -> int: ...

    @staticmethod
    def WebPAnimDecoderHasMoreFrames(dec: WebPAnimDecoderPointer) -> int: ...

    @staticmethod
    def WebPAnimDecoderGetNext(dec: WebPAnimDecoderPointer, buf: Pointer[Pointer[int]], timestamp: int) -> int: ...

    @staticmethod
    def WebPAnimDecoderReset(dec: WebPAnimDecoderPointer) -> None: ...

    @staticmethod
    def WebPAnimDecoderDelete(dec: WebPAnimDecoderPointer) -> None: ...