from typing import Any, Callable, overload, Generic, TypeVar, Literal, Tuple, Union

O = TypeVar("O")

class Pointer(Generic[O]): ...
class WebPDataPointer(lib.WebPData): ...
class WebPMemoryWriterPointer(lib.WebPMemoryWriter): ...
class WebPPicturePointer(lib.WebPPicture): ...
class WebPDecoderConfigPointer(lib.WebPDecoderConfig): ...
class WebPAnimEncoderOptionsPointer(lib.WebPAnimEncoderOptions): ...
class WebPAnimDecoderOptionsPointer(lib.WebPAnimDecoderOptions): ...
class WebPAnimInfoPointer(lib.WebPAnimInfo): ...
...
class ffi:
    ...
    @staticmethod
    @overload
    def new(ctype: Literal["WebPData*"]) -> WebPDataPointer: ...
    
    @staticmethod
    @overload
    def new(ctype: Literal["WebPMemoryWriter*"]) -> WebPMemoryWriterPointer: ...

    @staticmethod
    @overload
    def new(ctype: Literal["WebPPicture*"]) -> WebPPicturePointer: ...

    @staticmethod
    @overload
    def new(ctype: Literal["WebPDecoderConfig*"]) -> WebPDecoderConfigPointer: ...

    @staticmethod
    @overload
    def new(ctype: Literal["WebPAnimEncoderOptions*"]) -> WebPAnimEncoderOptionsPointer: ...

    @staticmethod
    @overload
    def new(ctype: Literal["WebPAnimDecoderOptions*"]) -> WebPAnimDecoderOptionsPointer: ...

    @staticmethod
    @overload
    def new(ctype: Literal["WebPAnimInfo*"]) -> WebPAnimInfoPointer: ...
